...
public class Puntos : MonoBehaviour
{
    ...
    {
        if (puntos.Length >= 5) Cambiar(5, blanco);
        else Cambiar(puntos.Length, blanco);
    ...
    public void Peligroso()
    {
        ...
        if (puntos.Length >= 5) Cambiar(5, verde);
        else Cambiar(puntos.Length, verde);
        
        Invoke("Tranquilo", Random.Range(1, 11));
    }

    public void Cambiar(int numero, Material color)
    {
